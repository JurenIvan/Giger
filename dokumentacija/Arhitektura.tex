\chapter{Arhitektura i dizajn sustava}
	...
	\textit{\bf Comment}
	\textit{Ovaj entitet sadrži informacije o komentaru. Sadrži atribute: id komentara, sadržaj komentara, datum i vrijeme objave komentara, id autora te id objave. Ovaj entitet je u \emph{Many-to-Many} vezi  sa entitetom Message\_seen te je u \emph{Many-to-many} vezi sa entitetima People i Post.}
	...
	\textit{\bf Message}
	\textit{Ovaj entitet sadrži informacije o poruci. Sadrži atribute: id poruke, sadržaj poruke, vrijeme kada je poruka poslana, id pošiljatelja, id benda pošiljatelja te id razgovora. Ovaj entitet je u \emph{Many-to-Many} vezi  sa entitetom Message\_seen te je u \emph{Many-to-many} vezi sa entitetima Conversation, Band i People.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{Ovaj entitet sadrži informacije o razgovoru. Sadrži atribute: id razgovora, id benda te url slike razgovora. Ovaj entitet je u \emph{One-to-Many} vezi  sa entitetima:Message, Band i Conversation\_user.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{Ovaj entitet sadrži informacije o korisniku u razgovoru. Sadrži atribute: id korisnika, id razgovora, te naziv razgovora. Ovaj entitet je u \emph{Many-to-One} vezi  sa entitetima:User i Conversation.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf System\_person}
	\textit{Ovaj entitet sadrži informacije o poruci. Sadrži atribute: id sustavskih podataka o korisniku, email adresu korisnika, identifikator zabrane korištanja aplikacije, hash lozinku korisnika, te identifikator za potvrđenu email adresu. Ovaj entitet je u \emph{One-to-Many} vezi  sa entitetima People i System\_person\_roles.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Person}
	\textit{Ovaj entitet sadrži opće informacije o korisniku. Sadrži atribute: id korisnika, telefonski broj korisnika, url slike korisnika, korisničko ime korisnika, id sustavskih podataka te ulogu korisnika,. Ovaj entitet je u \emph{Many-to-Many} vezi  sa entitetom Message\_seen te je u \emph{Many-to-many} vezi sa entitetima Conversation i User.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf System\_person\_roles}
	\textit{Ovaj entitet sadrži informacije o korisničkim ulogama. Sadrži atribute: id sustavskih podataka korisnika te ulogu korisnika. Ovaj entitet je u \emph{Many-to-One} vezi  sa entitetom System\_Person.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Organizer}
	\textit{Ovaj entitet sadrži informacije o organizatoru. Sadrži atribute: id organizatora te ime organizatora. Ovaj entitet je u \emph{One-to-Many} vezi  sa entitetima: Gig i People}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Band}
	\textit{Ovaj entitet sadrži informacije o bendu. Sadrži atribute: id benda, opis benda, datum osnutka benda, adresu benda, dodatak opisa benda, x koordinatu lokacije, y koordinatu lokacije, najveću udaljenost koju bend želi prijeći zbog gaže, ime benda, url slike benda te id voditelja benda. Ovaj entitet je u vezi \emph{Many-to-One} s entitetima: Conversation, Musician i Gig, te je u \emph{One-to-Many} vezi s entitetima: Gig\_type, Message, Musician\_bands, Band\_invited, Band\_invited\_backup\_members, Band\_backup\_members i Post.} 
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Occasion}
	\textit{Ovaj entitet sadrži informacije o događaju. Sadrži atribute: id događaja, opis događaja, datum održavanja događaja, oznaku za privatni događaj te id benda. Ovaj entitet je u emph{One-to-Many} vezi s entitetima: Band i Musician\_ocassion}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Musician\_ocassion}
	\textit{Ovaj entitet sadrži informacije o prisutsvu glazbenika na događajima. Sadrži atribute: id glazbenika te id događaja. Ovaj entitet je u vezi emph{Many-to-One} s entitetima: Musician i Ocassion.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Band\_invited\_back\_up\_members}
	\textit{Ovaj entitet sadrži informacije o glazbenicima koji su pozvani u bend kao rezerva. Sadrži atribute: id benda te id glazbenika pozvanih u bend kao rezerva. Ovaj entitet je u emph{Many-to-One} vezi s entitetima: Band i Musician.}
	...
	\end{longtabu}
		...
		\textit{\bf Band\_invited}
	\textit{Ovaj entitet sadrži informacije o glazbenicima koji su pozvani u bend. Sadrži atribute: id benda te id glazbenika pozvanih u bend. Ovaj entitet je u \emph{Many-to-One} vezi s entitetima: Band i Musician.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Band\_back\_up\_members}
	\textit{Ovaj entitet sadrži informacije o glazbenicima koji su u bendu kao rezerva. Sadrži atribute: id benda te id rezervnih glazbenika u bendu. Ovaj entitet je u emph{Many-to-One} vezi s entitetima: Band i Musician.}
	\begin{longtabu} to \textwidth {|X[6, l+8]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Musician\_bands}
	\textit{Ovaj entitet sadrži informacije o glazbenicima koji su u bendu. Sadrži atribute: id glazbenika te id benda. Ovaj entitet je u emph{Many-to-One} vezi s entitetima: Band i Musician.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Post}
	\textit{Ovaj entitet sadrži informacije o objavi korisnika. Sadrži atribute: id objave, sadržaj objave, datum i vrijeme objave, id benda te id autora. Ovaj entitet je u emph{Many-to-One} vezi s entitetima: Band i Musician te u emph{One-to-Many} vezi s entitetom Comment.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\end{longtabu}
		...
		\textit{\bf Musician}
	\textit{Ovaj entitet sadrži informacije o glazbeniku. Sadrži atribute: id glazbenika, oznaku za privatan kalendar te opis glazbenika. Ovaj entitet je u emph{One-to-Many} vezi s entitetima: Musician\_gig\_history, Band\_invited\_back\_up\_members, Instruments, Post, Band\_invited, Band\_back\_up\_members, Musician\_ocassions, Band i People.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Instruments}
	\textit{Ovaj entitet sadrži informacije o instrumentima koje sviraju glazbenici. Sadrži atribute: id instrumenta te id glazbenika. Ovaj entitet je u emph{Many-to-One} vezi s entitetima: Musician te Instrument.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Instrument}
	\textit{Ovaj entitet sadrži informacije o instrumentima. Sadrži atribute: id instrumenta, ime instrumenta te vrstu instrumenta. Ovaj entitet je u emph{One-to-Many} vezi s entitetom Instrument.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Musician\_gig\_history}
	\textit{Ovaj entitet sadrži informacije o nastupima glazbenika. Sadrži atribute: id nastupa te id glazbenika. Ovaj entitet je u emph{Many-to-One} vezi s entitetom Musician, Gig.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
	...
	\textit{\bf Gig}
	\textit{Ovaj entitet sadrži informacije o nastupima. Sadrži atribute: id nastupa, datum i vrijeme održavanja nastupa, opis nastupa, očekivano trajanje nastupa, oznaku za postignut dogovor, vrsta nastupa, adresa održavanja nastupa, dodatan opis nastupa, x koordinata lokacije, y koordinata lokacije, oznaku za privatan nastup, preporučenu cijenu ulaznice, id organizatora te id benda. Ovaj entitet je u emph{Many-to-One} vezi s entitetom Organizer te emph{One-to-Many} vezi s entitetima: Musician\_gig\_history, Review\_gig i Band.}
	\begin{longtabu} to \textwidth {|X[6, l+3]|X[6, l]|X[20, l]|}
