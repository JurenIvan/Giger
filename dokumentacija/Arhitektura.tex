\chapter{Arhitektura i dizajn sustava}
	...
	Prednost ostvarena automatiziranjem deployment procesa jest povećanje vjerojatnosti uspjesnosti deploya te povećanje udjela dostupnosti aplikacije zbog 2+2 instance servera.
