...
import {Button, Card, Carousel, Input, Modal} from 'antd';
      ...
      <ErrorBoundary>
        <div>
          ...
          <div style={{position: "relative", left: "23px", top: "2px"}}>
            ...
            <Carousel>
              <div>
                <h3>A lot of people say, </h3>
                <h4>'AC/DC - that's the band with the little guy who runs around in school shorts!'</h4>
                <h5>Search for bands below.</h5>
              </div>
            </Carousel>
